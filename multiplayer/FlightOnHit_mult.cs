...
public class FlightOnHit_mult : NetworkBehaviour {
    ...
    private void OnCollisionEnter(Collision collision)
    {
        ...
        if (hit)
        {
			...
			if(this.GetComponent<DamageManager_mult>()){
				this.GetComponent<DamageManager_mult>().RpcApplyDamage(Damage,collision.gameObject);
				Debug.Log ("flight_on_hit");
			}
		}	
    }
}
